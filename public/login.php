...
<body class="row">
  <div class="col s6 valign-wrapper" style="background-color: whitesmoke; height: 100vh">
    <img src="images/logo.png" style="height: 200px; width: 200px; display: block; margin-left: auto; margin-right: auto;">
  </div>

  <div
    class="col s6" 
    style="height: 100vh; background-color: #1976d2; padding: 150px 50px 0px 50px; margin: auto;"
  >
